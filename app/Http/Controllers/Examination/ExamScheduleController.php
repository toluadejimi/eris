            ...
            foreach ($request->get('sem_subject_id') as $key => $subject) {
                ...
                if ($selectedSubject != null) {
                    ...
                    $subjectUpdate = [
                        ...
                        'start_time' => '09:00:00'[$key],
                        'end_time' => '11:00:00'[$key],
                        ...
                        'full_mark_ca_test1' => $request->get('full_mark_ca_test1')[$key]?$request->get('full_mark_ca_test1')[$key]:0,
                        'pass_mark_ca_test1' => $request->get('pass_mark_ca_test1')[$key]?$request->get('pass_mark_ca_test1')[$key]:0,
                        'full_mark_ca_test2' => $request->get('full_mark_ca_test2')[$key]?$request->get('full_mark_ca_test2')[$key]:0,
                        'pass_mark_ca_test2' => $request->get('pass_mark_ca_test2')[$key]?$request->get('pass_mark_ca_test2')[$key]:0,
                        'full_mark_assign' => $request->get('full_mark_assign')[$key]?$request->get('full_mark_assign')[$key]:0,
                        'pass_mark_assign' => $request->get('pass_mark_assign')[$key]?$request->get('pass_mark_assign')[$key]:0,
                        'full_mark_class_exe' => $request->get('full_mark_class_exe')[$key]?$request->get('full_mark_class_exe')[$key]:0,
                        'pass_mark_class_exe' => $request->get('pass_mark_class_exe')[$key]?$request->get('pass_mark_class_exe')[$key]:0,
                        'full_mark_affective' => $request->get('full_mark_affective')[$key]?$request->get('full_mark_affective')[$key]:0,
                        'pass_mark_affective' => $request->get('pass_mark_affective')[$key]?$request->get('pass_mark_affective')[$key]:0,
                        'full_mark_physc' => $request->get('full_mark_physc')[$key]?$request->get('full_mark_physc')[$key]:0,
                        'pass_mark_physc' => $request->get('pass_mark_physc')[$key]?$request->get('pass_mark_physc')[$key]:0,
        ...
        if ($request->has('semester_id')) {
            ...
            if($existSubject) {
                ...
                $schedule = ExamSchedule::select('exam_schedules.subjects_id',
                    ...
                    'exam_schedules.full_mark_theory',
                    'exam_schedules.pass_mark_theory',
