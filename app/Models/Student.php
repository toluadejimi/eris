...
{
    protected $fillable = ['created_by', 'hospital_doctor_name', 'doc_phone', 'hospital_address', 'relative_name',   'pick_phone_2',  'relative_no', 'pick_phone', 'pick_child', 'pick_child_2', 'body_max', 'child_name_consent', 'physical_activities_reasons', 'physical_activities', 'dietary_needs', 'hospital_address', 'medications', 'program_condition', 'other_information', 'weight', 'health_issues', 'other_health_issues', 'photo_publicity', 'emergency_relationship', 'challenges', 'hear_about_us', 'emergency_name', 'emergency_contact', 'last_updated_by', 'name_of_scholar_3', 'date_of_scholar_birth_3', 'reg_no', 'reg_date', 'university_reg', 'state_of_origin', 'lga', 'to_date_2', 'name_of_school', 'date_of_scholar_birth', 'year_group', 'name_of_scholar_2', 'date_of_scholar_birth_2', 'year_group_2', '', 'from_date', 'from_date_2', 'name_of_scholar', 'to_date', 'name_of_school_2', 'faculty', 'semester', 'batch',
