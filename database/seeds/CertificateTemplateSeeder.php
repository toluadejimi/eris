    ...
    public function run()
    {
        DB::table('certificate_templates')->insert([
            [
                ...
                'template' => '<table class="table table-bordered"> <tbody> <tr> <td>01.</td> <td style="text-align: right; ">Name of Student :&nbsp;</td> <td width="50%" style="text-align: left;"><b>{{student_name}}</b><br></td> </tr> <tr> <td>02.</td> <td style="text-align: right; ">Reg. No.&nbsp;:&nbsp;</td> <td width="50%" style="text-align: left;"><span style="font-weight: 700;">{{reg_no}}</span><br></td> </tr> <tr> <td>03.</td> <td style="text-align: right; ">STATE OF ORIGIN.&nbsp;:&nbsp;</td> <td width="50%" style="text-align: left;"><span style="font-weight: 700;">{{university_reg}}</span><br></td> </tr> <tr> <td>04.</td> <td style="text-align: right; ">Faculty/Level&nbsp;:&nbsp;</td> <td width="50%" style="text-align: left;"><span style="font-weight: 700;">{{faculty}}</span><br></td> </tr><tr><td>05.</td><td style="text-align: right; ">Batch :&nbsp;<br></td><td width="50%" style="text-align: left;"><span style="font-weight: 700;">{{batch}}</span><br></td></tr> <tr> <td>06.</td> <td style="text-align: right; ">Year of Study&nbsp;:&nbsp;</td> <td width="50%" style="text-align: left;"><span style="font-weight: 700;">{{year_of_study}}</span><br></td> </tr> <tr> <td>07.</td> <td style="text-align: right; ">Percentage of Attendance Secured&nbsp;:&nbsp;</td> <td width="50%" style="text-align: left;"><b>{{percentage_of_attendance}}%</b><br></td> </tr> </tbody></table>',
