<div class="clearfix hidden-print ">
    <div class="easy-link-menu">
        ...
        <a class="{!! request()->is('exam/mark-ledger/import')?'btn-success':'btn-primary' !!} btn-sm" href="{{ route('exam.mark-ledger.import') }}"><i class="fa fa-upload" aria-hidden="true"></i>&nbsp;Bulk Upload</a>
    </div>
</div>
<hr class="hr-6">