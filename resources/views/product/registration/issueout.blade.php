            ...
            <div class="page-content">
                ...
                <div class="row">
                    ...
                    <!-- PAGE CONTENT BEGINS -->
                        ...
                        {!! Form::open(['route' => $base_route.'.issue', 'method' => 'POST', 'class' => 'form-horizontal',
                        ...
                        <div class="form-group">
                            {!! Form::label('qty_out', 'Quantity Out', ['class' => 'col-sm-2 control-label']) !!}
                            <div class="col-sm-2">
                                {!! Form::number('qty_out', isset($data['qty_out'])?$data['qty_out']:null, ["class" => "form-control border-form", "required"]) !!}
                                @include('includes.form_fields_validation_message', ['name' => 'qty_out'])
                            </div>

                            {!! Form::label('issued_to', 'Issued To', ['class' => 'col-sm-2 control-label']) !!}
                            <div class="col-sm-2">
                                {!! Form::text('issued_to', isset($data['issued_to'])?$data['issued_to']:null, ["class" => "form-control border-form"]) !!}
                                @include('includes.form_fields_validation_message', ['name' => 'issued_to'])
                            </div>


                            <label class="col-sm-1 control-label">Class</label>
                            <div class="col-sm-2">
                                {!! Form::select('faculty_id', $data['faculty'], null, ['class' => 'form-control']) !!}
                                @include('includes.form_fields_validation_message', ['name' => 'faculty_id'])
                            </div>
                        </div>
