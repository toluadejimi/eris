                    ...
                    <div class="row">
                        <div class="d-flex justify-content-start col-2">
                            @if(isset($generalSetting->logo))
                                <img class="editable img-responsive"
                                     ...
                                     alt="HTML5 Icon" style="width:100px;height:100px;">
                            @endif
                        </div>
                        <div class=" col-8 text-center" style="font-size: 14px">
                            ...
                            <h2 class="no-margin-top text-uppercase"
                                style="font-family: 'Bowlby+One+SC'; font-size: 15px; font-weight: 600">
...
{{--                        </div>--}}
                        ...
                        @if($student->subjects && $student->subjects->count() > 0)
                            ...
                            @foreach($student->subjects as $subject)
                                <tr>
                                    ...
                                    --}}
                                    <td style="font-size: 10px">{{ViewHelper::getSubjectById($subject->subjects_id)}}</td>
                ...
                --}}
                        ...
                        <b>
                            <td colspan="5" class="text-right"><strong>AVERAGE MARK : {{$average}}</b>
                        </td>
                        <B>
                            <td colspan="6" class="text-right"><strong>TOTAL MARK SCORED : {{ $totalmarks }}</b>
                        </td>
                ...
                <div class="smaller-100 d-flex justify-content-center my-2">
                    ...
                    @elseif (($average >= 41 && $average <= 50.9))
                        PRINCIPAL'S COMMENT: |  Pass. Fair academic performance. There is need for academic
                        re-awakening.
                    @elseif (($average <= 40))
                ...
                <div class="d-flex justify-content-center col-4">
                    <img id="avatar" class="nav-user-photo" alt=""
                         src="{{ asset('assets/images/avatars/stamp.png') }}"
                         width="100px"/>
