    ...
    <div class="main-content-inner">
        <div class="page-content">
            <div class="pay-fee-card">
                ...
                <p class="pay-fee-message">To view this exam result, please ensure all school fees have been paid. Kindly make payment using the account details below before you can access the result.</p>
